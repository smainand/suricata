...
#ifndef __APP_LAYER_S7_H__
#define __APP_LAYER_S7_H__
...
typedef struct s7Transaction_ {
    ...
    TAILQ_ENTRY(s7Transaction_) next;

} s7Transaction;

typedef struct s7State_ {

    TAILQ_HEAD(, s7Transaction_) tx_list; /**< List of s7 transactions
